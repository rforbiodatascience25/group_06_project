...
-   Assess GC content, genome length, completeness & contamination
-   Investigate if associated MAGs form a distinct genomic group
-   Evaluate possible taxonomic clustering
:::
...
![](../results/08_key_plot_1.png){width="87%"} ![](../results/08_key_plot_2.png){width="87%"} ![](../results/08_key_plot_3.png){width="87%"}
