...
## 6.1 Distribution of completeness (Til præsentation)
...
## 6.2 Distribution of contamination (Til præsentation)
...
genome_metadata_aug |>
  count(Completeness_quality) |>
  ggplot(aes(x = Completeness_quality,
             y = n,
...
genome_metadata_aug |>
  count(Contamination_quality) |>
  ggplot(aes(x = Contamination_quality,
             y = n,
...
## 9.2 Genomes per continent (Til præsentation)
