...
phylogenetic_tree_plot <- ggtree(
  ...
  theme(
    ...
    plot.caption = element_text(hjust = 0.5, size = 6, color = "grey40"),
    legend.title = element_text(face = "bold"))

phylogenetic_tree_plot
ggsave("../results/phylogenetic_tree_plot.png", phylogenetic_tree_plot, width = 10, height = 10, dpi = 300)
```
